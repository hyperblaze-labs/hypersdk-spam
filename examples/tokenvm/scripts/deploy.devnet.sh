...
if [ -f /tmp/avalanche-ops-cache/token-cli ]; then
  ...
  wget "https://github.com/hyperblaze-labs/hypersdk-spam/releases/download/v${HYPERSDK_VERSION}/tokenvm_${HYPERSDK_VERSION}_${DEPLOYER_OS_TYPE}_${DEPLOYER_ARCH_TYPE}.tar.gz"
...
if [ -f /tmp/avalanche-ops-cache/tokenvm ]; then
  ...
  wget "https://github.com/hyperblaze-labs/hypersdk-spam/releases/download/v${HYPERSDK_VERSION}/tokenvm_${HYPERSDK_VERSION}_linux_amd64.tar.gz"
  mkdir -p /tmp/token-installs
