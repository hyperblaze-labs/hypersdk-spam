...
// Source: github.com/hyperblaze-labs/hypersdk-spam/state (interfaces: Immutable)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_immutable.go github.com/hyperblaze-labs/hypersdk-spam/state Immutable
//
