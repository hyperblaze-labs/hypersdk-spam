...
// Source: github.com/hyperblaze-labs/hypersdk-spam/state (interfaces: Mutable)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_mutable.go github.com/hyperblaze-labs/hypersdk-spam/state Mutable
//
