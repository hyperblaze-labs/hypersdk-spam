...
// Source: github.com/hyperblaze-labs/hypersdk-spam/state (interfaces: View)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_view.go github.com/hyperblaze-labs/hypersdk-spam/state View
//
